...
<<<<<<< Updated upstream
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2023-09-09 10:37:46" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2023-09-09 10:37:46" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2023-09-09 10:37:46" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2023-09-09 10:37:46" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2023-09-09 10:37:46" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2023-09-09 10:37:46" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2023-09-09 10:37:46" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "copilot" ("2023-09-09 10:37:46" ("emacs" "s" "dash" "editorconfig" "jsonrpc") (:host github :repo "zerolfx/copilot.el" :files ("dist" "*.el") :package "copilot" :type git :local-repo "copilot.el")) "s" ("2023-09-09 10:37:46" nil (:type git :flavor melpa :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "dash" ("2023-09-09 10:37:46" ("emacs") (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "editorconfig" ("2023-09-09 10:37:46" ("emacs" "nadvice") (:type git :flavor melpa :host github :repo "editorconfig/editorconfig-emacs" :package "editorconfig" :local-repo "editorconfig-emacs")) "jsonrpc" ("2023-09-09 10:37:46" ("emacs") (:type git :host github :repo "emacs-straight/jsonrpc" :files ("*" (:exclude ".git")) :package "jsonrpc" :local-repo "jsonrpc")) "openai" ("2023-09-08 08:13:42" ("emacs" "request" "tblui") (:host github :repo "emacs-openai/openai" :package "openai" :type git :local-repo "openai")) "request" ("2023-09-08 08:13:36" ("emacs") (:type git :flavor melpa :files ("request.el" "request-pkg.el") :host github :repo "tkf/emacs-request" :package "request" :local-repo "emacs-request")) "tblui" ("2023-09-08 08:13:41" ("dash" "magit-popup" "tablist" "cl-lib") (:type git :flavor melpa :host github :repo "Yuki-Inoue/tblui.el" :package "tblui" :local-repo "tblui.el")) "magit-popup" ("2023-09-08 08:13:39" ("emacs" "dash") (:type git :flavor melpa :host github :repo "magit/magit-popup" :package "magit-popup" :local-repo "magit-popup")) "tablist" ("2023-09-08 08:13:41" ("emacs") (:type git :flavor melpa :host github :repo "emacsorphanage/tablist" :package "tablist" :local-repo "tablist")) "chatgpt" ("2023-09-08 08:16:24" ("emacs" "openai" "lv" "ht" "markdown-mode" "spinner") (:host github :repo "emacs-openai/chatgpt" :package "chatgpt" :type git :local-repo "chatgpt")) "lv" ("2023-09-08 08:13:55" nil (:type git :flavor melpa :files ("lv.el" "lv-pkg.el") :host github :repo "abo-abo/hydra" :package "lv" :local-repo "hydra")) "ht" ("2023-09-08 08:14:00" ("dash") (:type git :flavor melpa :host github :repo "Wilfred/ht.el" :package "ht" :local-repo "ht.el")) "markdown-mode" ("2023-09-08 08:14:19" ("emacs") (:type git :flavor melpa :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode")) "spinner" ("2023-09-08 08:16:24" ("emacs") (:type git :host github :repo "emacs-straight/spinner" :files ("*" (:exclude ".git")) :package "spinner" :local-repo "spinner")) "codegpt" ("2023-09-08 08:17:04" ("emacs" "openai" "markdown-mode" "spinner") (:host github :repo "emacs-openai/codegpt" :package "codegpt" :type git :local-repo "codegpt")) "dall-e" ("2023-09-08 08:16:57" ("emacs" "openai" "lv" "ht" "spinner" "reveal-in-folder" "async") (:host github :repo "emacs-openai/dall-e" :package "dall-e" :type git :local-repo "dall-e")) "reveal-in-folder" ("2023-09-08 08:16:53" ("emacs" "f" "s") (:type git :flavor melpa :host github :repo "jcs-elpa/reveal-in-folder" :package "reveal-in-folder" :local-repo "reveal-in-folder")) "f" ("2023-09-08 08:16:53" ("emacs" "s" "dash") (:type git :flavor melpa :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el")) "async" ("2023-09-08 08:16:57" ("emacs") (:type git :flavor melpa :host github :repo "jwiegley/emacs-async" :package "async" :local-repo "emacs-async"))))
...
=======
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2023-09-09 11:04:50" nil (:type git :host github :repo "radian-software/straight.el" :branch "master" :package "straight" :local-repo "straight.el"))))
>>>>>>> Stashed changes
...
(fn &optional ARG)" t nil) (register-definition-prefixes "copilot" '("copilot-")) (register-definition-prefixes "copilot-balancer" '("copilot-balancer-")) (provide 'copilot-autoloads)) "request" ((request-autoloads request) (autoload 'request-response-header "request" "Fetch the values of RESPONSE header field named FIELD-NAME.
